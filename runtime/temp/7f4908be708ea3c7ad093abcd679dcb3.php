<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\phpTPstudy\www\pyg\public/../application/home\view\cart\index.html";i:1569505826;s:55:"D:\phpTPstudy\www\pyg\application\home\view\layout.html";i:1570583529;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
								<li class="yui3-u-1-24">
									<input type="checkbox" <?php if(($v['is_selected'])): ?>checked="checked"<?php endif; ?> class="row_check" name="" id="" value="" />
								</li>
