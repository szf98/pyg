<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\phpTPstudy\www\pyg\public/../application/home\view\safe\safe.html";i:1570604113;s:55:"D:\phpTPstudy\www\pyg\application\home\view\layout.html";i:1570583529;s:60:"D:\phpTPstudy\www\pyg\application\home\view\member_left.html";i:1570677942;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="body userSafe">
                        ...
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form class="sui-form form-horizontal sui-validate" action="<?php echo url('home/safe/setsafe'); ?>" id="jsForm">
                                    <div class="control-group">
                                        <label for="inputusername" class="control-label">用户名：</label>
                                        <div class="controls">
                                            <input id="pwdid" class="fn-tinput" data-rule-remote="http://www.baidu.com" name="nickname" placeholder="<?php echo \think\Session::get('user_info.nickname'); ?>"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="fn-tinput" type="password" name="password" value="<?php echo \think\Session::get('password'); ?>" placeholder="新密码" required id="password" data-rule-remote="php.php">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputRepassword" class="control-label">重复密码：</label>
                                        <div class="controls">
                                            <input class="fn-tinput" type="password" name="confirm" value="<?php echo \think\Session::get('confirm'); ?>" placeholder="确认新密码" required equalTo="#password">
                                        </div>
                                    </div>
                            ...
                            <div id="two" class="tab-pane">
                                ...
                                <form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="bind-form">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls fixed">手机验证（<?php echo \think\Session::get('user_info.username'); ?>）</div>                            
                                    </div>
                                     <div class="control-group">
