<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpTPstudy\www\pyg\public/../application/home\view\login\login.html";i:1570431321;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div id="profile" class="tab-pane  active">
							<form action="<?php echo url('home/login/dologin'); ?>" method="post" class="sui-form">
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="username" name="username" type="text" placeholder="邮箱/手机号" class="span2 input-xfat">
								</div>
