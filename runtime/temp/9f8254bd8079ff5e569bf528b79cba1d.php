<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpTPstudy\www\pyg\public/../application/home\view\info\index.html";i:1570624223;s:55:"D:\phpTPstudy\www\pyg\application\home\view\layout.html";i:1570583529;s:60:"D:\phpTPstudy\www\pyg\application\home\view\member_left.html";i:1570761924;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="body userInfo">
                        ...
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form id="form-msg" action="<?php echo url('home/info/setinfo'); ?>" class="sui-form form-horizontal">
                                    <div class="control-group">
                                        <label for="inputName" class="control-label" >email：</label>
                                        <div class="controls">
                                            <input type="text" id="inputName" name="email" placeholder="<?php echo $info['email']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label data-toggle="radio" class="radio-pretty inline <?php if($info['user_sex'] == 1): ?>checked<?php endif; ?>">
                                            <input type="radio" name="user_sex" value="1"><span>男</span>
                                        </label>
                                            <label data-toggle="radio" class="radio-pretty inline <?php if($info['user_sex'] == 2): ?>checked<?php endif; ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="job" name="job" placeholder="职业" value="<?php echo $info['job']; ?>">
                                        </div>
                                    </div>
...
<script>
            $(function() {               
				...
				$('#up_img_WU_FILE_0').change(function(){
                    ...
                    $.ajax({
                        "url":"<?php echo url('home/my_setting/figure'); ?>",
                        "type":"post",
                        "data":formData,
                        "dataType":"json",
                        "contentType":false,
